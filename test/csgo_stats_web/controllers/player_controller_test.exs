defmodule CsgoStatsWeb.PlayerControllerTest do
  ...
  @create_attrs %{adr: 120.5, assist_count: 42, death_count: 42, deaths_traded: 42, first_deaths: 42, first_kills: 42, headshot_count: 42, kast: 120.5, kill_count: 42, name: "some name", rounds_played: 42, teamnum: 42, trade_kills: 42, userid: 42, xuid: 42}
